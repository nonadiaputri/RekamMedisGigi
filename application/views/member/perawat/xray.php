          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                <div class="col-xs-12">
                  <div class="box" style="background:#c6d7ef ">
                    <div class="box-header">
                      <div class="box-body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('c_perawat/upload_xray');?>">
                          <div class="form-group">
                            <label for="pic_file">Pilih File X-ray:</label>
              ...
              <!-- <div class="box-body">
                <div class="row">
                <div class="col-md-9">
                  <?php echo form_open_multipart('c_perawat/upload_xray');?>
                  <h3>Dokumen X-ray</h3>
                  <hr>
                  <div class="form-group">
                        ...
                        <table id="example2" class="table table-bordered table-hover" style="width: 100%;">
                          ...
                          <tr>
                            ...
                            <td><a href="<?=base_url().'assets/foto_medis/'.$key->nama_foto;?>" target="_blank"></a>
                              <img src="<?=base_url().'assets/foto_medis/'.$key->nama_foto;?>" style="width:200px ; height:200px"></td>
                            <td>
                              <a href="<?php echo base_url()."c_perawat/hapus_xray/".$key->id_foto.'/'.$key->id_pasien;?>" class="btn btn-danger" role="button">Hapus</a>
                            </td>
                          </tr>
                        </tbody>
                          <?php $num++; } ?>
