      ...
      <section class="content">
        ...
        <!--  -->
                ...
                <div class="tab-pane" id="ubahdt" >
                  <form method="post" class="form-horizontal" action="<?php echo base_url('c_perawat/update_dtmds');?>" >
                    <?php 
                        foreach ($pasien as $key) { ?>
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-info" href="<?php echo base_url('c_perawat/update_dtmds');?>">Submit</button>
