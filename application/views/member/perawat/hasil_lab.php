              ...
              <div class="box-body">
                <div class="col-xs-12">
                  <div class="box" style="background:#c6d7ef ">
                    <div class="box-header">
                      <div class="box-body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('c_perawat/upload_lab');?>">
                      ...
                      <div class="col-xs-12">
                        ...
                        <table id="example2" class="table table-bordered table-hover" style="width: 100%;">
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url()."c_perawat/hapus_hasil_lab/".$key->id_foto.'/'.$key->id_pasien;?>" class="btn btn-danger" role="button">Hapus</a>
                            </td>
                          </tr>
                        </tbody>
                          <?php $num++; } ?>
