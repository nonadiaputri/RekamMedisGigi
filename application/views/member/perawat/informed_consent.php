              ...
              <div class="box-body">
                <div class="col-xs-12">
                  <div class="box" style="background:#c6d7ef ">
                    <div class="box-header">
                      <div class="box-body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('c_perawat/upload_informed');?>">
                      ...
                      <div class="col-xs-12">
                        ...
                        <table id="example2" class="table table-bordered table-hover" style="width: 100%;">
                          ...
                          <tr>
                            ...
                            <td><a href="<?=base_url().'assets/upload_files/'.$key->doc_acceptance;?>" target="_blank">
                              <img src="<?=base_url().'assets/upload_files/'.$key->doc_acceptance;?>" style="width:200px ; height:200px"></td>
                            <td>
                              <a href="<?php echo base_url()."c_perawat/hapus_doc_inform/".$key->id_doc.'/'.$key->id_pasien;?>" class="btn btn-danger" role="button">Delete</a>
                            </td>
                          </tr>
                        </tbody>
                          <?php $num++; } ?>
