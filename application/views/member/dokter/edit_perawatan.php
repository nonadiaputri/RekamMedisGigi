          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="editpr">
              	<form class="form-horizontal" method="post" action="<?php echo base_url('c_dokter/update_perawatan');?>">
                ...
                <select id="K14_9s" name="kode_icd2" class="form-control">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" style="float: right;"class="btn btn-info" href="<?php echo base_url('c_dokter/update_perawatan');?>">Submit</button>
<!--                       <button type="submit" style="float: left;" class="btn btn-info" href="<?php echo base_url('c_dokter/DataPerawatan/'.$key->id_pasien);?>">Kembali</button> --> 
                      <?php  } ?> 
                    </div>
                  </div>
                </form>
    ...
    <script>
      ...
      //jgn d ubah
      //render data ke selection box
      if(icd != ""){
      $("#k1").val(icd);
      var n_icd1 = $("#k1").val();
      console.log("cd"+n_icd1);
      $("#kode_icdn").val(n_icd1);
      $("#"+ icd).show();
      var cari = $("#"+icd).find("#"+icd);
      cari.val(icd1);
      $("#"+icd).find("#"+icd).val(icd1);
      console.log("cd1"+icd1);
      $("#kode_icd1n").val(icd);
      if (icd2 != "") {
          $("#" + icd1).show();
          $("#"+icds).val(icd2);
...
console.log(correspondingID);
        ...
        //ubah dari selection box ketiga
        console.log($("#"+icds));
        $("#"+icds).change(function(){
          correspondingID3 = $(this).find(":selected").val();
          console.log("3"+correspondingID3);
          $("#kode_icd2n").val(correspondingID3);
          $("#kode_icd1n").val(icd1);;
          ...
          //ubah dari selection box pertama
          $("#k1").change(function() {
          correspondingID = $(this).find(":selected").val()
          console.log("1"+correspondingID);
          $("#kode_icdn").val(correspondingID);
