              ...
              <div class="box-body">
                <div class="col-xs-12">
                  <div class="box" style="background:#c6d7ef ">
                    <div class="box-header">
                      <div class="box-body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('c_dokter/upload_refusal');?>">
                      ...
                      <div class="col-xs-12">
                        ...
                        <table id="example2" class="table table-bordered table-hover" style="width: 100%;">
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url()."c_dokter/hapus_doc_refusal/".$key->id_doc.'/'.$key->id_pasien;?>" class="btn btn-danger" role="button">Delete</a>
                            </td>
                          </tr>
                          <?php $num++; } ?>
                          </tbody>
