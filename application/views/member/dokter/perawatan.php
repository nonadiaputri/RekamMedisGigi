  <!DOCTYPE html>
    ...
    var icd2;
      ...
      $.ajax({
        url:"<?php echo base_url('c_dokter/spesific_perawatan/');?>" + id_per,
        type:"POST",
        dataType:'JSON',
        success:function(data){
          ...
          $('#tabel-lihat').find('#kode_icd1').html(data.perawatan[0].kode_icd1);
          $('#tabel-lihat').find('#kode_icd2').html(data.perawatan[0].kode_icd2);
