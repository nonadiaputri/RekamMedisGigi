          ...
          <div class="col-xs-12">
            ...
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#datapasien" data-toggle="tab">Biodata Pasien</a></li>
                <li><a href="#ubahdt" data-toggle="tab">Ubah Biodata Pasien</a></li>
              </ul>
              <div class="tab-content">
                ...
                <div class="tab-pane" id="ubahdt">
                  <form method="post" class="form-horizontal" action="<?php echo base_url('c_dokter/do_update');?>" >
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-info" href="<?php echo base_url('c_dokter/do_update');?>">Simpan</button>
                      </div>
                    </div>
                  </form>
                </div>
